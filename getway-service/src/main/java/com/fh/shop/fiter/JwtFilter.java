...
//            throw new ShopException(ResponseEnum.TOKEN_HEADER_IS_NULL);
        ...
        String member = new String(Base64.getDecoder().decode(memberVo64),StandardCharsets.UTF_8);
        String sout = new String(Base64.getDecoder().decode(sout64),StandardCharsets.UTF_8);
